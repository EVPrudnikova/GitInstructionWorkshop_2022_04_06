...
### **pull reqest** – запрос (в виде присланного файла (ветки) с предложениями) на вливание изменений в чужой репозиторий.

Как это сделать?

Если захотелось поучаствовать в каком-то проекте, для начала нужно скопировать репозиторий.
Делаем Fork (в верхнем правом углу на GitHub) и репозиторий копируется в личный аккаунт.

| **Fork** – вилка, ответвление от главного репозитория, копия|
---

Со своего аккаунта мы можем этот репозиторий забрать. Копируем ссылку.
Открываем папку на локальном компьютере в VSC.
Открываем терминал и вводим поочередно комманды.

* git clone _ссылка_ 

* cd _скопированная папка_
...
* git commit –m “Добавили описание к проекту” – сделали изменения на отдельной ветке и хотим предложить их владельцу исходного репозитория

* git push – на свой аккаунт

_git push --set-upstream origin description – может предложить git_

В личном кабинете появляется новая ветка и кнопка **compare & pull request**, можно добавить комментарий и предложить свою версию владельцу исходного репозитория.
